            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                        <li class="nav-item active ms-auto mt-2 mt-lg-0"><a class="nav-link" href="https://github.com/Nishogi/EDEN" target="_blank">code source</a></li>
                        <liv class="nav-item active">
                        <a class="nav-link dropdown-toggle ms-auto mt-2 mt-lg-0" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Team</a>
